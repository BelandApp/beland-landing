...
export function About() {
  const historyVideoUrl =
    "https://player.vimeo.com/video/1110359756?h=44f715cb59&autoplay=1";
          ...
          <div>
            <VideoModal videoUrl={historyVideoUrl} title="Nuestra Historia">
              <div className="relative group cursor-pointer rounded-lg overflow-hidden shadow-lg">
                <Image
                  src="https://vumbnail.com/1110359756.jpg" // Generates thumbnail from video
                  alt="Thumbnail de video de Nuestra Historia"
                  width={600}
                  height={400}
                ...
                <div className="absolute inset-0 bg-black bg-opacity-30 group-hover:bg-opacity-10 transition-all duration-300 flex items-center justify-center">
                  <PlayCircle className="h-20 w-20 text-white text-opacity-80 group-hover:text-opacity-100 transform group-hover:scale-110 transition-transform duration-300" />
                </div>
              </div>
            </VideoModal>
          </div>
