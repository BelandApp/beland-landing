    ...
    <section className="py-20 bg-background border-t border-border/50">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          ...
          <p className="text-muted-foreground text-lg italic md:max-w-xs border-l-2 border-primary/30 pl-4 transition-all">
            "{videos[index].title}"
          </p>
        </div>

        {/* Visor de Video Adaptable */}
        <div className="relative aspect-video rounded-[2.5rem] overflow-hidden bg-black shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-white/10 group">
          ...
          {/* Lógica para mostrar Video Local o Vimeo */}
