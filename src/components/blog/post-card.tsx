  ...
  return (
    <Card className="flex flex-col overflow-hidden h-full hover:shadow-xl transition-shadow duration-300">
      ...
      <CardHeader>
        ...
        <CardDescription className="pt-2 text-card-foreground/80">{post.description}</CardDescription>
      </CardHeader>
      <CardContent className="flex-grow"></CardContent>
      <CardFooter className="flex justify-between items-center text-sm text-card-foreground/60">
        <span>{post.date}</span>
